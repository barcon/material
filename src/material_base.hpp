...
namespace material
{
	...
	public:
		...
		virtual Scalar GetTensileStrength(Scalar temperature, Scalar pressure) const = 0;
		virtual Scalar GetYieldStrength(Scalar temperature, Scalar pressure) const = 0;
		virtual Scalar GetShearStrength(Scalar temperature, Scalar pressure) const = 0;
		virtual Scalar GetLimitingSurfacePressure(Scalar temperature, Scalar pressure) const = 0;
		...
		virtual void SetTensileStrength(IScalar2DPtr value) = 0;
		virtual void SetYieldStrength(IScalar2DPtr value) = 0;
		virtual void SetShearStrength(IScalar2DPtr value) = 0;
		virtual void SetLimitingSurfacePressure(IScalar2DPtr value) = 0;
